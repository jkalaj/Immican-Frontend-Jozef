...
const UploadDocument = () => {
  ...
  const documentTypeOptions = ['National ID Card', 'Passport Copy', 'Driving License', 'Work Permit', 'Educational Certificate'];

  const additionalOptions = {
    'Educational Certificate': ['High School Diploma', "Bachelor's Degree", "Master's Degree", "IELTS Certificate"],
  };
